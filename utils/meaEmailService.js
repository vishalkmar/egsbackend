 ...
 * returns: { subject, text, html, send(enquiry) }
 */
const buildUserEmail = (enquiry) => {
  const subject = "MEA Attestation Enquiry Received";

  const text = `
Dear ${enquiry.name?.trim() ? enquiry.name : "Applicant"},

We have received your MEA Attestation enquiry.

Enquiry Details:
- Email: ${enquiry.email}
- Contact: ${enquiry.contact}
- Country: ${enquiry.country}
- Document Category: ${enquiry.docCategory}
...
`.trim();
  ...
  <div style="font-family:Arial,sans-serif;line-height:1.6;color:#111">
    ...
    <p>We have received your MEA Attestation enquiry.</p>
    ...
    <ul>
      ...
      <li><b>Document Category:</b> ${enquiry.docCategory}</li>
...
const buildAdminEmail = (enquiry) => {
  const subject = `New MEA Enquiry: ${enquiry.email} (${enquiry.docType})`;
  ...
  const html = `
  <div style="font-family:Arial,sans-serif;line-height:1.6;color:#111">
    <h2 style="margin:0 0 12px">New MEA Attestation Enquiry</h2>
    <ul>
      <li><b>Name:</b> ${enquiry.name || "-"}</li>
      <li><b>Email:</b> ${enquiry.email}</li>
      <li><b>Contact:</b> ${enquiry.contact}</li>
      <li><b>Country:</b> ${enquiry.country}</li>
      <li><b>Category:</b> ${enquiry.docCategory}</li>
      <li><b>Type:</b> ${enquiry.docType}</li>
      <li><b>No. of Documents:</b> ${enquiry.noOfDocuments}</li>
      <li><b>Enquiry Date:</b> ${enquiry.enquiryDate}</li>
      <li><b>Submitted At:</b> ${new Date(enquiry.submittedAt).toLocaleString()}</li>
    </ul>
  ...
  const text = `
New MEA Attestation Enquiry

Name: ${enquiry.name || "-"}
Email: ${enquiry.email}
Contact: ${enquiry.contact}
Country: ${enquiry.country}
Category: ${enquiry.docCategory}
Type: ${enquiry.docType}
No. of Documents: ${enquiry.noOfDocuments}
Enquiry Date: ${enquiry.enquiryDate}
Submitted At: ${new Date(enquiry.submittedAt).toLocaleString()}
