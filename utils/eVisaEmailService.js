...
const buildUserEmail = (enquiry) => {
  const subject = "E-Visa Enquiry Received";

  const text = `
Dear ${enquiry.name?.trim() ? enquiry.name : "Applicant"},

We have received your E-Visa enquiry.
...
`.trim();
  ...
  <div style="font-family:Arial,sans-serif;line-height:1.6;color:#111">
    ...
    <p>We have received your E-Visa enquiry.</p>
...
const buildAdminEmail = (enquiry) => {
  const subject = `New E-Visa Enquiry: ${enquiry.email} (${enquiry.visaType})`;
  ...
  const html = `
  <div style="font-family:Arial,sans-serif;line-height:1.6;color:#111">
    <h2 style="margin:0 0 12px">New E-Visa Enquiry</h2>
    <ul>
