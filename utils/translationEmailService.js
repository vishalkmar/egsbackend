...
const buildUserEmail = (enquiry) => {
  const subject = "Translation Enquiry Received";
...
- Source Language: ${enquiry.sourceLanguage}
- Target Language: ${enquiry.targetLanguage}
...
`.trim();
  ...
  <div style="font-family:Arial,sans-serif;line-height:1.6;color:#111">
    ...
    <p>We have received your Translation enquiry.</p>
    <h3 style="margin:16px 0 8px">Enquiry Details</h3>
    <ul>
      <li><b>Email:</b> ${enquiry.email}</li>
      <li><b>Contact:</b> ${enquiry.contact}</li>
      <li><b>Source Language:</b> ${enquiry.sourceLanguage}</li>
      <li><b>Target Language:</b> ${enquiry.targetLanguage}</li>
...
const buildAdminEmail = (enquiry) => {
  const subject = `New Translation Enquiry: ${enquiry.email} (${enquiry.docType})`;
  ...
  const html = `
  <div style="font-family:Arial,sans-serif;line-height:1.6;color:#111">
    <h2 style="margin:0 0 12px">New Translation Enquiry</h2>
    <ul>
